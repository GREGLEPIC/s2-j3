...
def pick_send
  ...
  journaliste_sample.each do |journaliste|
  @client.update("#{journaliste} Votre dernier article est vraiment génial, merci ! #bonjour_monde #the_hacking_pro")
  end
end

def like_bonjour_monde
  @client.search('#bonjour_monde', result_type: "recent").take(25).each do |like|
  @client.fav(like)
  end
end
